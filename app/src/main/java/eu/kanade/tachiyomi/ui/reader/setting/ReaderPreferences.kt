...
class ReaderPreferences(
    ...
    fun translationSourceLang() = preferenceStore.getString("translation_source_lang", "auto")
    fun translationTargetLang() = preferenceStore.getString("translation_target_lang", "es")
    fun translationFontSize() = preferenceStore.getFloat("translation_font_size", 14f)
    fun translationInterval() = preferenceStore.getInt("translation_interval", 5)
    // SY <--
